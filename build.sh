...
# cross compiling relies on TARGETOS/TARGETARCH/TARGETVARIANT environment variables
...
exec go build -ldflags="-s -w" -trimpath -o /certspotter software.sslmate.com/src/certspotter/cmd/certspotter
